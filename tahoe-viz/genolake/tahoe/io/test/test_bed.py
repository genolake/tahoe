...
class BedFileTest(IOTestCase):
    ...
    def test_column_type(self):
        ...
        d1, d2, d3 = dataframe._tahoe_parse
    ...
    def test_to_json(self):
        ...
        assert(type(dataframe._tahoe_to_json) == str)
        assert(is_valid_json(dataframe._tahoe_to_json) == True)
    ...
    def test_visualization(self):
        ...
        assert(str(type(reads)) == '<class \'genolake.tahoe.pileup.pileupViewer.PileupViewer\'>')
